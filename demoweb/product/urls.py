...
urlpatterns = [
    ...
    path(
        "login/",
        auth_views.LoginView.as_view(template_name="product/login.html"),
        name="login",
    ),
    path("logout/", auth_views.LogoutView.as_view(next_page="/"), name="logout"),
    path("add_to_cart/<int:id>/", views.add_to_cart, name="add_to_cart"),
    path(
        "remove_orderDetail/<int:id>/",
        views.remove_orderDetail,
        name="remove_orderDetail",
    ),
    ...
    path(
        ...
        PasswordChangeDoneView.as_view(template_name="product/passwordone.html"),
